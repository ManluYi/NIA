...
SOLVER_CMD=(
    python3
    /mnt/home/yimanlu/nia/scripts/python/run_z3_with_progress.py
    --z3-root
    "$SOLVER_BASE/z3-master"
    --z3-exe
    "$SOLVER_EXE"
    --timeout-ms
    "$TIMEOUT_MS"
...
if [ -f "../python/tongji_NIA.py" ]; then
    ...
    python3 ../python/tongji_NIA.py "z3" --input_dir "$INPUT_DIR" --result_dir "$RESULT_DIR"
fi
